...
class MnemoDB(object):
    ...
    def ensure_index(self):
        ...
        self.db.url.ensure_index('extractions.hashes.md5', unique=False)
        self.db.url.ensure_index('extractions.hashes.sha1', unique=False)
        self.db.url.ensure_index('extractions.hashes.sha512', unique=False)
